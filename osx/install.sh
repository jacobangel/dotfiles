...
sudo scutil --set ComputerName "Oathkeeper"
sudo scutil --set HostName "Oathkeeper"
sudo scutil --set LocalHostName "Oathkeeper"
...
# Top left screen corner → Show application window
...
# open "$HOME/shell/setup.terminal"
sleep 1 # Wait a bit to make sure the theme is loaded
# defaults write com.apple.terminal "Default Window Settings" -string "jake"
# defaults write com.apple.terminal "Startup Window Settings" -string "jake"
